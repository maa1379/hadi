# Generated by Django 3.2.1 on 2022-02-13 07:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(auto_now_add=True)),
                ('user', models.ForeignKey(limit_choices_to='is_admin', on_delete=django.db.models.deletion.CASCADE, to='account.user')),
            ],
        ),
    ]
