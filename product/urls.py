...
from .views import  AllProductList,SearchView, InternalProductPanelList, \
    InternalProductDetail, InternalProductCreateView, ExportalProductPanelList, \
...
urlpatterns = [
    ...
    path("rejected_product_uploade/", RejectedProductCreateView.as_view(), name="rejected_product_update"),
